...
import numpy as np
from white_notes import findWhiteNotes
def process_line(input_y, img_array, width, difference_between_lines_for_line_drawing, difference_between_lines, line_height, Image):
    black_notes = []
    white_notes = []
    dashed_whites = []
    black_count = 0
    
    white_notes = findWhiteNotes(input_y, img_array, width, difference_between_lines_for_line_drawing, difference_between_lines, line_height)
